...
local cpu = lain.widget.sysload({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup("#00FF7C", " CPU: ") .. load_1 .. "GHz "))
    end
})
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup("#FF8F00", " RAM: ") .. mem_now.used .. "MB "))
    end
})
...
local bat = lain.widget.bat({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup("#FF0087", " Battery: ") .. perc .. "% "))
    end
})
